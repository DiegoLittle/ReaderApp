...
export default function SignIn({ csrfToken }: Props) {
  ...
  async function signInRequest(e) {
    e.preventDefault()
    let body = { csrfToken, username: email, password }
    console.log(email)
    const res = await fetch('/api/auth/callback/credentials', {
      method: 'POST',
      body: new URLSearchParams(
        `csrfToken=${csrfToken}&username=${email}&password=${password}`
      ),
    })
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            ...
            <Link href="/auth/signup">
              <a className="font-medium text-fountain-blue-600 hover:text-fountain-blue-500">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input
                    ...
                    name="remember-me"
                    type="checkbox"
                    className="h-4 w-4 rounded border-gray-300 text-fountain-blue-600 focus:ring-fountain-blue-500"
                  />
                  <label
                    htmlFor="remember-me"
                ...
                <div className="text-sm">
                  <a
                    ...
                    className="cursor-pointer font-medium text-fountain-blue-600 hover:text-fountain-blue-500"
                  >
