      ...
      <div className="app__content">
        <div className="app__content-wrapper">
          ...
          <div className="app__content-main">
            <Annotator
              url={"https://arxiv.org/pdf/2205.08094.pdf"}
          ...
          <div className="absolute right-0 top-40 app__content-entities w-1/4">
            <h1>Entities</h1>
            {
