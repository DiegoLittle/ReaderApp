...
// const EventBus = dynamic(() => import('pdfjs-dist/legacy/web/pdf_viewer').then((module) => module.EventBus), {
//     ssr: false
//   });
// const PDFViewer = dynamic(() => import('pdfjs-dist/legacy/web/pdf_viewer').then((module) => module.PDFViewer), {
// ssr: false
// });
// const PDFLinkService = dynamic(() => import('pdfjs-dist/legacy/web/pdf_viewer').then((module) => module.PDFLinkService), {
// ssr: false
// });
...
export class PdfHighlighter extends PureComponent {
    ...
    async componentDidMount() {
        const { EventBus, PDFViewer, PDFLinkService, } = await import("pdfjs-dist/web/pdf_viewer")
