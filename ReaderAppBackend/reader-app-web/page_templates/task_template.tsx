...
import EvaluationTable from '../components/evaluation_table'
        ...
        <div>
            <>
                ...
                >
                            ...
                            <>
                                ...
                                <div className=''>
                                    {data.datasets && data.datasets.map((dataset) =>
                                        <>
                                            <h1 className='text-lg font-medium'>{dataset.dataset}</h1>
                                            <span>{dataset.description}</span>
                                            <div >
                                                <EvaluationTable sota={dataset.sota}></EvaluationTable>
                    ...
                    className="my-6"
                    >
                        <h1 className='text-xl font-semibold'>Subtasks:</h1>
                    {data.subtasks.map((task)=>
                    <div className="my-3">
                        <h1 className='text-lg font-medium'>{task.task}</h1>
                        <span><ReactMarkdown>{task.description}</ReactMarkdown></span>
                    </div>
                    )}
                    </div>
